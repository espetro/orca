...
| `config/scripts/live-remote-freeze-rpc.mts`                    | Cross-platform bounded CLI runner  |
| `config/scripts/live-remote-bulk-open-freeze-metrics.mts`      | Shared thresholds / handle extract |
