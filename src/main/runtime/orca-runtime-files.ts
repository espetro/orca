...
export class RuntimeFileCommands {
  ...
  listMobileFiles: RuntimeFileMobileCommands['listMobileFiles'] = (...args) =>
    this.mobile.listMobileFiles(
      ...(args as Parameters<RuntimeFileMobileCommands['listMobileFiles']>)
    )
  searchMobileFilePaths: RuntimeFileMobileCommands['searchMobileFilePaths'] = (...args) =>
    this.mobile.searchMobileFilePaths(
      ...(args as Parameters<RuntimeFileMobileCommands['searchMobileFilePaths']>)
    )
  searchQuickOpenFilePaths: RuntimeFileMobileCommands['searchQuickOpenFilePaths'] = (...args) =>
    this.mobile.searchQuickOpenFilePaths(
      ...(args as Parameters<RuntimeFileMobileCommands['searchQuickOpenFilePaths']>)
    )
  ...
  resolveTerminalPath: RuntimeFileTerminalPathCommands['resolveTerminalPath'] = (...args) =>
    this.terminal.resolveTerminalPath(
      ...(args as Parameters<RuntimeFileTerminalPathCommands['resolveTerminalPath']>)
    )
  readTerminalArtifactFile: RuntimeFileArtifactCommands['readTerminalArtifactFile'] = (...args) =>
    this.artifact.readTerminalArtifactFile(
      ...(args as Parameters<RuntimeFileArtifactCommands['readTerminalArtifactFile']>)
    )
  readTerminalArtifactPreview: RuntimeFileArtifactCommands['readTerminalArtifactPreview'] = (
    ...args
  ) =>
    this.artifact.readTerminalArtifactPreview(
      ...(args as Parameters<RuntimeFileArtifactCommands['readTerminalArtifactPreview']>)
    )
  writeTerminalArtifactFile: RuntimeFileArtifactCommands['writeTerminalArtifactFile'] = (...args) =>
    this.artifact.writeTerminalArtifactFile(
      ...(args as Parameters<RuntimeFileArtifactCommands['writeTerminalArtifactFile']>)
    )
  revokeTerminalFileGrantsForClient: RuntimeFileTerminalPathCommands['revokeTerminalFileGrantsForClient'] =
    (...args) =>
      this.terminal.revokeTerminalFileGrantsForClient(
        ...(args as Parameters<
          RuntimeFileTerminalPathCommands['revokeTerminalFileGrantsForClient']
        >)
      )
  readFileExplorerDir: RuntimeFileExplorerReadCommands['readFileExplorerDir'] = (...args) =>
    this.explorerRead.readFileExplorerDir(
      ...(args as Parameters<RuntimeFileExplorerReadCommands['readFileExplorerDir']>)
    )
  watchFileExplorer: RuntimeFileExplorerReadCommands['watchFileExplorer'] = (...args) =>
    this.explorerRead.watchFileExplorer(
      ...(args as Parameters<RuntimeFileExplorerReadCommands['watchFileExplorer']>)
    )
  closeFileExplorerWatchersForPath: RuntimeFileExplorerReadCommands['closeFileExplorerWatchersForPath'] =
    (...args) =>
      this.explorerRead.closeFileExplorerWatchersForPath(
        ...(args as Parameters<RuntimeFileExplorerReadCommands['closeFileExplorerWatchersForPath']>)
      )
  restoreFileExplorerWatchersAfterFailedRemoval: RuntimeFileExplorerReadCommands['restoreFileExplorerWatchersAfterFailedRemoval'] =
    (...args) =>
      this.explorerRead.restoreFileExplorerWatchersAfterFailedRemoval(
        ...(args as Parameters<
          RuntimeFileExplorerReadCommands['restoreFileExplorerWatchersAfterFailedRemoval']
        >)
      )
  forgetFileExplorerWatchersAfterRemoval: RuntimeFileExplorerReadCommands['forgetFileExplorerWatchersAfterRemoval'] =
    (...args) =>
      this.explorerRead.forgetFileExplorerWatchersAfterRemoval(
        ...(args as Parameters<
          RuntimeFileExplorerReadCommands['forgetFileExplorerWatchersAfterRemoval']
        >)
      )
  readFileExplorerPreview: RuntimeFileExplorerReadCommands['readFileExplorerPreview'] = (...args) =>
    this.explorerRead.readFileExplorerPreview(
      ...(args as Parameters<RuntimeFileExplorerReadCommands['readFileExplorerPreview']>)
    )
  readDocPreviewFile: RuntimeFileExplorerReadCommands['readDocPreviewFile'] = (...args) =>
    this.explorerRead.readDocPreviewFile(
      ...(args as Parameters<RuntimeFileExplorerReadCommands['readDocPreviewFile']>)
    )
  readFileExplorerChunk: RuntimeFileExplorerReadCommands['readFileExplorerChunk'] = (...args) =>
    this.explorerRead.readFileExplorerChunk(
      ...(args as Parameters<RuntimeFileExplorerReadCommands['readFileExplorerChunk']>)
    )
  writeFileExplorerFile: RuntimeFileExplorerWriteCommands['writeFileExplorerFile'] = (...args) =>
    this.explorerWrite.writeFileExplorerFile(
      ...(args as Parameters<RuntimeFileExplorerWriteCommands['writeFileExplorerFile']>)
    )
  writeFileExplorerFileBase64: RuntimeFileExplorerWriteCommands['writeFileExplorerFileBase64'] = (
    ...args
  ) =>
    this.explorerWrite.writeFileExplorerFileBase64(
      ...(args as Parameters<RuntimeFileExplorerWriteCommands['writeFileExplorerFileBase64']>)
    )
  writeFileExplorerFileBase64Chunk: RuntimeFileExplorerWriteCommands['writeFileExplorerFileBase64Chunk'] =
    (...args) =>
      this.explorerWrite.writeFileExplorerFileBase64Chunk(
        ...(args as Parameters<
          RuntimeFileExplorerWriteCommands['writeFileExplorerFileBase64Chunk']
        >)
      )
  createFileExplorerFile: RuntimeFileExplorerWriteCommands['createFileExplorerFile'] = (...args) =>
    this.explorerWrite.createFileExplorerFile(
      ...(args as Parameters<RuntimeFileExplorerWriteCommands['createFileExplorerFile']>)
    )
  createFileExplorerDir: RuntimeFileExplorerWriteCommands['createFileExplorerDir'] = (...args) =>
    this.explorerWrite.createFileExplorerDir(
      ...(args as Parameters<RuntimeFileExplorerWriteCommands['createFileExplorerDir']>)
    )
  createFileExplorerDirNoClobber: RuntimeFileExplorerWriteCommands['createFileExplorerDirNoClobber'] =
    (...args) =>
      this.explorerWrite.createFileExplorerDirNoClobber(
        ...(args as Parameters<RuntimeFileExplorerWriteCommands['createFileExplorerDirNoClobber']>)
      )
  commitFileExplorerUpload: RuntimeFileExplorerWriteCommands['commitFileExplorerUpload'] = (
    ...args
  ) =>
    this.explorerWrite.commitFileExplorerUpload(
      ...(args as Parameters<RuntimeFileExplorerWriteCommands['commitFileExplorerUpload']>)
    )
  renameFileExplorerPath: RuntimeFileExplorerWriteCommands['renameFileExplorerPath'] = (...args) =>
    this.explorerWrite.renameFileExplorerPath(
      ...(args as Parameters<RuntimeFileExplorerWriteCommands['renameFileExplorerPath']>)
    )
  copyFileExplorerPath: RuntimeFileExplorerWriteCommands['copyFileExplorerPath'] = (...args) =>
    this.explorerWrite.copyFileExplorerPath(
      ...(args as Parameters<RuntimeFileExplorerWriteCommands['copyFileExplorerPath']>)
    )
  deleteFileExplorerPath: RuntimeFileExplorerWriteCommands['deleteFileExplorerPath'] = (...args) =>
    this.explorerWrite.deleteFileExplorerPath(
      ...(args as Parameters<RuntimeFileExplorerWriteCommands['deleteFileExplorerPath']>)
    )
  searchRuntimeFiles: RuntimeFileListingCommands['searchRuntimeFiles'] = (...args) =>
    this.listing.searchRuntimeFiles(
      ...(args as Parameters<RuntimeFileListingCommands['searchRuntimeFiles']>)
    )
  listRuntimeFiles: RuntimeFileListingCommands['listRuntimeFiles'] = (...args) =>
    this.listing.listRuntimeFiles(
      ...(args as Parameters<RuntimeFileListingCommands['listRuntimeFiles']>)
    )
  listRuntimeMarkdownDocuments: RuntimeFileListingCommands['listRuntimeMarkdownDocuments'] = (
    ...args
  ) =>
    this.listing.listRuntimeMarkdownDocuments(
      ...(args as Parameters<RuntimeFileListingCommands['listRuntimeMarkdownDocuments']>)
    )
  statRuntimeFile: RuntimeFileListingCommands['statRuntimeFile'] = (...args) =>
    this.listing.statRuntimeFile(
      ...(args as Parameters<RuntimeFileListingCommands['statRuntimeFile']>)
    )
}
