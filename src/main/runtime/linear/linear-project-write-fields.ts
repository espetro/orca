...
export class LinearProjectWriteFields {
  constructor(private readonly host: RuntimeLinearCommandHost) {}

async resolveLinearCreateProject(
  input: string,
...
async readLinearProjectByIdForCreate(
  id: string,
  workspaceId: string
...
async readLinearProjectsForCreate(
  query: string,
  workspaceId: string
): Promise<LinearProjectSummary[]> {
  try {
...
async readLinearProjectsByExactNameForCreate(
  name: string,
  workspaceId: string
): Promise<LinearProjectSummary[]> {
  try {
...
async assertLinearProjectIncludesTeam(
...
async filterLinearProjectsForTeam(
...
linearProjectIncludesTeam(project: LinearProjectSummary, teamId: string): boolean {
