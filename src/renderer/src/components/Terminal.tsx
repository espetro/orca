...
import { useTerminalShortcutKeybindings } from './terminal/use-terminal-shortcut-keybindings'
import { LiveTerminalTabBar } from './terminal/live-terminal-tab-bar'
import { WorktreeSplitSurface } from './terminal/worktree-split-surface'
import { SaveConfirmDialog, WindowCloseConfirmDialog } from './terminal/terminal-close-dialogs'
import { getActiveWorktreeRuntimeEnvironmentId } from './terminal/active-worktree-runtime-environment'
import {
  haveSameIdSet,
  isPinnedActiveEditorTab,
  isPinnedVisibleTab,
  isPinnedEditorFileTab
} from './terminal/unified-tab-store-queries'
import { showClientCreationActionError } from './terminal/client-creation-error'
...
function Terminal(): React.JSX.Element | null {
  ...
  useTerminalShortcutKeybindings({
    activeWorktreeId,
    keybindings,
  ...
  return (
    ...
    >
      ...
      <WindowCloseConfirmDialog
        ...
        onOpenChange={setWindowCloseDialogOpen}
        onConfirm={confirmNativeWindowClose}
      />
    </div>
  )
}
