import { CJK_LATIN_SPACED_TERMS } from './locale-cjk-latin-spaced-terms.ts'
import {
  isCanonicalGenericRendering,
  overlapsCanonicalRendering
} from './locale-generic-ui-terms.ts'
import { isScreenCursorContext } from './locale-screen-cursor-exemptions.ts'
import { BRAND_MISTRANSLATIONS } from './locale-brand-mistranslations.ts'
import { isStyleValue } from './locale-style-values.ts'
import { LOCALE_KEY_OVERRIDES } from './locale-key-overrides.ts'
import { LOCALE_PHRASE_FIXES } from './locale-phrase-fixes.ts'
import { SEARCH_KEYWORD_OVERRIDES } from './locale-search-keyword-overrides.ts'
import { LOCALE_VALUE_OVERRIDES } from './locale-value-overrides.ts'
...
export { SEARCH_KEYWORD_OVERRIDES } from './locale-search-keyword-overrides.ts'
...
// name a product (agent, terminal, commit, repo, Continue) live in locale-generic-ui-terms.ts
