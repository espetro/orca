 ...
 */
export function nextDailyBuildNumber(baseVersion: string, releaseNames: string[] = []) {
 ...
 */
export function formatDailyReleaseName(
  version: string,
  buildNumber: number,
  commit: string,
  date: Date
...
export function getDailyBuildIdentity(
  now: Date = new Date(),
  {
    publishedVersions,
    releaseNames
