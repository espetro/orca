...
import { selectStaleDevBundleDirs } from './dev-electron-bundle-cache.ts'
...
function getDevBundleProcessTable(): string | null {
  ...
  // from being truncated. The raw text is searched directly; see dev-electron-bundle-cache.ts
