...
const scriptPath = 'config/scripts/check-terminal-perf-report-budgets.mts'
const tempDirs: string[] = []

function writeReport(annotationDescription: string, annotationType = 'opencode-test'): string {
