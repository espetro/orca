...
const orcaDevScript = path.join(scriptDir, 'orca-dev.ts')
const ensureNativeRuntimeScript = path.join(scriptDir, 'ensure-native-runtime.ts')
...
const stdoutLines = createInterface({ input: child!.stdout as NodeJS.ReadableStream })
