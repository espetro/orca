import { KO_PHRASE_FIXES_ROUND4 } from './locale-ko-phrase-fixes.ts'
import { ZH_PHRASE_FIXES_ROUND5 } from './locale-zh-phrase-fixes-round5.ts'

import { JA_PHRASE_FIXES } from './locale-ja-phrase-fixes.ts'
