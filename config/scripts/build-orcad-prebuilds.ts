 ...
 *
 * Usage:
 *   node config/scripts/build-orcad-prebuilds.ts [--slot=linux-x64-musl]
 *   node config/scripts/build-orcad-prebuilds.ts --require-slots   # release gate
 */
...
if (process.argv[1] && process.argv[1].endsWith('build-orcad-prebuilds.ts')) {
